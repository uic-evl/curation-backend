...
exports.fetchFiguresFromDocument = async (req, res, next) => {
  ...
  try {
    ...
    res.statusCode(500).send({error, message: 'Error while fetching figures'})
  }
}
...
exports.updateSubfigure = async (req, res, next) => {
  ...
  try {
    ...
    res.statusCode(500).send({error, message: 'Error while updating subfigure'})
  }
}
...
exports.createDocumentFromPipeline = async (req, res, next) => {
  ...
  try {
    ...
    res.statusCode(500).send({error, message: 'Error inserting from pipeline'})
  }
}
